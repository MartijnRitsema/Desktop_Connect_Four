...
public class Cell extends JButton {
    ...
    Cell(int row, int col) {
        ...
        setOpaque(true);  // Set to true to make the background color visible
        ...
        for (int r = 0; r < HEIGHT; r++) {
            for (int c = 0; c < WIDTH; c++) {
                ...
                if (c + 3 < WIDTH &&
                    ...
                    board[r][c + 1].setBackground(Color.red);
                    board[r][c + 2].setBackground(Color.red);
                    board[r][c + 3].setBackground(Color.red);
                    return player;
                }
                if (r + 3 < HEIGHT) {
                    if (Objects.equals(player, board[r + 1][c].getText()) &&
                        ...
                        board[r][c].setBackground(Color.red);
                        board[r + 1][c].setBackground(Color.red);
                        board[r + 2][c].setBackground(Color.red);
                        board[r + 3][c].setBackground(Color.red);
                        return player;
                    }
                    if (c + 3 < WIDTH &&
                        ...
                        board[r][c].setBackground(Color.red);
                        board[r + 1][c + 1].setBackground(Color.red);
                        board[r + 2][c + 2].setBackground(Color.red);
                        board[r + 3][c + 3].setBackground(Color.red);
                        return player;
                    }
                    if (c - 3 >= 0 &&
                            Objects.equals(player, board[r + 1][c - 1].getText()) &&
